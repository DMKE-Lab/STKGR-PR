...
parser.add_argument('--time_dim', type=int, default=200, metavar='T',
                    help='time embedding dimension (default: 200)')
...
parser.add_argument('--time_only', action='store_true',
                    help='search with time information only, ignoring entity representation (default: False)')
parser.add_argument('--time_only_in_path', action='store_true',
                    help='include intermediate entities in path (default: False)')
